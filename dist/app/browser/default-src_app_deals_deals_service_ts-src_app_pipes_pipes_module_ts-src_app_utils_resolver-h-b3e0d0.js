(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-src_app_deals_deals_service_ts-src_app_pipes_pipes_module_ts-src_app_utils_resolver-h-b3e0d0"],{
...
/* harmony import */ var _listing_deals_listing_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./listing/deals-listing.model */ 87287);
/* harmony import */ var _details_deals_details_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./details/deals-details.model */ 33983);
/* harmony import */ var _utils_transfer_state_helper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/transfer-state-helper */ 15009);
...
class DealsService {
  ...
  get relativeDates() {
    return [dayjs__WEBPACK_IMPORTED_MODULE_0__().add(1, 'day').add(8, 'hour').add(10, 'second').format('MM/DD/YYYY HH:mm:ss'), dayjs__WEBPACK_IMPORTED_MODULE_0__().add(7, 'day').format('MM/DD/YYYY'), dayjs__WEBPACK_IMPORTED_MODULE_0__().subtract(1, 'month').format('MM/DD/YYYY'), dayjs__WEBPACK_IMPORTED_MODULE_0__().add(2, 'month').format('MM/DD/YYYY')];
  }
  getListingDataSource() {
    const rawDataSource = this.http.get('./assets/sample-data/deals/listing.json').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(data => {
      ...
      const listing = new _listing_deals_listing_model__WEBPACK_IMPORTED_MODULE_2__.DealsListingModel();
  ...
  getListingStore(dataSource) {
    ...
    if (!this.listingDataStore) {
      ...
      const shellModel = new _listing_deals_listing_model__WEBPACK_IMPORTED_MODULE_2__.DealsListingModel();
      ...
      if ((0,_angular_common__WEBPACK_IMPORTED_MODULE_6__.isPlatformServer)(this.platformId) || dataSource['ssr_state']) {
  ...
  getDetailsDataSource() {
    const rawDataSource = this.http.get('./assets/sample-data/deals/details.json').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(data => {
      const expirationDate = dayjs__WEBPACK_IMPORTED_MODULE_0__().add(1, 'day').add(8, 'hour').add(10, 'second').format('MM/DD/YYYY HH:mm:ss');
      ...
      // Note: HttpClient cannot know how to instantiate a class for the returned data
      // We need to properly cast types from json data
      const details = new _details_deals_details_model__WEBPACK_IMPORTED_MODULE_3__.DealsDetailsModel();
      // The Object.assign() method copies all enumerable own properties from one or more source objects to a target object.
  ...
  getDetailsStore(dataSource) {
    // Initialize the model specifying that it is a shell model
    const shellModel = new _details_deals_details_model__WEBPACK_IMPORTED_MODULE_3__.DealsDetailsModel();
    this.detailsDataStore = new _shell_data_store__WEBPACK_IMPORTED_MODULE_1__.DataStore(shellModel);
    // If running in the server, then don't add shell to the Data Store
    // If we already loaded the Data Source in the server, then don't show a shell when transitioning back to the broswer from the server
    if ((0,_angular_common__WEBPACK_IMPORTED_MODULE_6__.isPlatformServer)(this.platformId) || dataSource['ssr_state']) {
      // Trigger loading mechanism with 0 delay (this will prevent the shell to be shown)
  ...
  static #_ = this.ɵfac = function DealsService_Factory(t) {
    return new (t || DealsService)(_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_7__.PLATFORM_ID), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_utils_transfer_state_helper__WEBPACK_IMPORTED_MODULE_4__.TransferStateHelper), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_8__.HttpClient));
  };
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DealsDetailsModel": () => (/* binding */ DealsDetailsModel)
/* harmony export */ });
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dayjs */ 16901);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _shell_data_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../shell/data-store */ 29760);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DealsItemModel": () => (/* binding */ DealsItemModel),
/* harmony export */   "DealsListingModel": () => (/* binding */ DealsListingModel)
/* harmony export */ });
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dayjs */ 16901);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _shell_data_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../shell/data-store */ 29760);
...
//# sourceMappingURL=default-src_app_deals_deals_service_ts-src_app_pipes_pipes_module_ts-src_app_utils_resolver-h-b3e0d0.js.map